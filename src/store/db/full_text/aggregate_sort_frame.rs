use super::*;
pub(super) fn compare_fulltext_aggregate_rows(
...
pub(super) fn fulltext_aggregate_frame(total: usize, rows: Vec<FullTextAggregateRow>) -> Frame {
...
pub(super) fn fulltext_aggregate_value_frame(value: FullTextAggregateValue) -> Frame {
    match value {
