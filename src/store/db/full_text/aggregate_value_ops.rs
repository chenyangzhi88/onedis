use super::*;
pub(super) fn compare_fulltext_aggregate_values(
...
pub(super) fn fulltext_aggregate_value_truthy(value: &FullTextAggregateValue) -> bool {
    match value {
...
pub(super) fn fulltext_aggregate_value_to_number(
...
pub(super) fn fulltext_aggregate_value_to_string(value: &FullTextAggregateValue) -> String {
    match value {
...
pub(super) fn format_fulltext_aggregate_number(value: f64) -> String {
    if value.fract() == 0.0 {
        format!("{value:.0}")
    } else {
        value.to_string()
...
pub(super) fn normalize_fulltext_aggregate_field(field: &str) -> String {
