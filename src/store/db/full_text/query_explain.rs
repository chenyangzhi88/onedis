use super::*;
pub(super) fn fulltext_explain_ast_lines(ast: &FullTextQueryAst) -> Vec<String> {
    let mut lines = Vec::new();
    fulltext_explain_ast_into(ast, 0, &mut lines);
    lines
}

pub(super) fn fulltext_explain_ast_into(
...
pub(super) fn fulltext_explain_numeric_bound(bound: FullTextNumericBound) -> String {
    match bound {
