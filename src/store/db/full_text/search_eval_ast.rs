use super::*;
pub(super) fn fulltext_eval_ast_against_fields(
...
pub(super) fn fulltext_effective_document_language(
    fields: &[(String, String)],
    meta: &FullTextIndexMeta,
    options: &FullTextSearchOptions,
) -> String {
...
pub(super) fn fulltext_phrase_matches(
    value: &str,
    phrase: &str,
    language: &str,
    slop: u32,
...
pub(super) fn fulltext_ordered_phrase_matches(
    source: &[String],
    query: &[String],
    slop: usize,
) -> bool {
...
pub(super) fn fulltext_phrase_with_slop_matches(
    source: &[String],
    query: &[String],
    slop: usize,
) -> bool {
...
pub(super) fn fulltext_phrase_position_search(
...
pub(super) fn fulltext_any_text_field_matches(
    term: &str,
    fields: &[(String, String)],
    meta: &FullTextIndexMeta,
) -> bool {
    fields.iter().any(|(field, value)| {
        ...
        variants.iter().any(|variant| {
            fulltext_tokenize(&materialized.1)
                .iter()
...
pub(super) fn fulltext_schema_field<'a>(
