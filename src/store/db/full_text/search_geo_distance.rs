use super::*;
pub(super) fn fulltext_geo_value_within(
    value: &str,
    lon: f64,
    lat: f64,
    radius: f64,
...
pub(super) fn parse_fulltext_geo_value(value: &str) -> Result<(f64, f64), Error> {
    let parts = value
...
pub(super) fn fulltext_geo_unit_meters(unit: &str) -> Result<f64, Error> {
...
pub(super) fn fulltext_haversine_meters(lat1: f64, lon1: f64, lat2: f64, lon2: f64) -> f64 {
